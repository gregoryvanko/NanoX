class NanoXMenuBar {
    ...
    BuildViewMobileMenu(){
        let divbar = NanoXBuild.Div(this._IdNanoXMobileMenu, "NanoXMobileMenu")
        // Safe space on IOS
